...
`PokeGoNexus-manual-1eea14cb-arm64-v8a.apk`, rebuilt on the other machine
and retrieved from the `public` share. Its supplied checksum matches the
downloaded file and the installed APK:
